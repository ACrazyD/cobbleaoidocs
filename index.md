...
These pages contain the live ProbeJS results from this pack, grouped by namespace with one ID per line.

- [Items](modregister-items.html): 47,043 item IDs
- [Blocks](modregister-blocks.html): 39,243 block IDs
- [Fluids](modregister-fluids.html): 433 fluid IDs
- [Gases](modregister-gases.html): Gas-tagged resources and handler notes
